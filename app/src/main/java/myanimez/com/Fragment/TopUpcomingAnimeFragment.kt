...
class TopUpcomingAnimeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_top_upcoming_anime, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        top_upcoming_anime_recycleview.adapter = adapter.withLoadStateFooter(footer = ExampleLoadStateAdapter{ adapter.retry() })

        val layoutManager = GridLayoutManager(context, 3)

        top_upcoming_anime_recycleview.layoutManager = layoutManager
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId)
        {
            R.id.toolbar_list_view -> {
                ...
                if(isGridView){
                    top_upcoming_anime_recycleview.layoutManager = GridLayoutManager(context, 3)
                    item.icon = ContextCompat.getDrawable(context!!, R.drawable.ic_list)
                }
                else{
                    top_upcoming_anime_recycleview.layoutManager =
                ...
                top_upcoming_anime_recycleview.adapter =
